---
title: "Motion Chart of Moore's Law"
author: "Richard Yang"
date: '2017-02-19'
categories:
- motion chart
...
## Objectives
Moore's law has been the golden law to predict the semiconductor device size and guide the long-term planning of semiconductor industry in the last 3 decades. It has been accuractely describing a driving force behind technological and economical growth.
...
2. Formate data for motion chart
...
node <- read_excel("data/Moore_law.xlsx",sheet="count")
head(node)
...
3. Format year and process.node
4. Unique rows or idvar and time var
5. Set x axis to node.nm and y axis to transistor count

```{r motion chart, results='asis', tidy=FALSE}
...
- Note to be able to display googleVis chart: resolved with macro setting on the manual
